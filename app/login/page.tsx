...
<div className="w-1/2 relative">
  ...
  type="submit"
  disabled={loading}
  className="w-full py-4 font-bold text-white rounded-lg transition-all duration-200 disabled:opacity-60 hover:brightness-110 active:scale-[0.98] disabled:active:scale-100"
  style={{ backgroundColor: '#7B1111' }}
>
  {loading ? (
